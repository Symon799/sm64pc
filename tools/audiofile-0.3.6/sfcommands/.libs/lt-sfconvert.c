...
/* ./.libs/lt-sfconvert.c - temporary wrapper executable for .libs/sfconvert.exe
   Generated by libtool (GNU libtool) 2.4.6

   The sfconvert program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\Users\\Symon\\Desktop\\sm64pc-master\\sm64pc-master\\tools\\audiofile-0.3.6\\libaudiofile\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\Users\\Symon\\Desktop\\sm64pc-master\\sm64pc-master\\tools\\audiofile-0.3.6\\libaudiofile\\.libs;C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "sfconvert.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sfconvert - temporary wrapper script for .libs/sfconvert.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The sfconvert program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"sfconvert.exe:sfconvert:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sfconvert.exe:sfconvert:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sfconvert.exe:sfconvert:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=/c/Users/Symon/Desktop/sm64pc-master/sm64pc-master/tools/audiofile-0.3", f);
  fputs (".6/libaudiofile/.libs:/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/Symon/Desktop/sm64pc-master/sm64pc-master/tools/audiofile-0.", f);
  fputs ("3.6/libaudiofile/.libs:$PATH\"\n", f);
  fputs ("\n", f);
